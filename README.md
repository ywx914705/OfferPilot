<div align="center">
  ...
  **AI-Powered Interview Prep System**
  ...
  [![Version: 4.0](https://img.shields.io/badge/Version-4.0-green.svg?style=flat-square)]()
...
- **学习进度追踪，越练越精准** — 自动记录模拟面试成绩、错题本、薄弱点，生成个性化学习报告
...
| "查看我的学习进度" | 读取 .offerpilot/progress.md -> 输出掌握度总览+错题本+薄弱点清单 |
...
| 进度追踪 | "查看我的学习进度" | 掌握度总览+错题本+薄弱点清单+每日打卡 |
...
输出：掌握度总览 -> 错题本(含复习提醒) -> 薄弱点清单 -> 每日打卡记录 -> 针对性复习建议
...
每次模拟面试或专项突破后，AI 会自动更新 `.offerpilot/progress.md`，记录掌握度评分、错题本、薄弱点和每日打卡。下次使用时会读取历史数据，针对性出题（错题优先、薄弱点加强）。你可以随时说"查看我的学习进度"查看完整报告。
